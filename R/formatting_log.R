...
df_variable_tracker <- tibble::tribble(
                                  ~Variable,   ~Action,                                                                                                                                                     ~Rationale,
                                    "i.fcs",   "Added", "computed with fs_fcs_cerealgrainroottuber, fs_fcs_beansnuts, fs_fcs_vegetableleave, fs_fcs_fruit, fs_fcs_meatfishegg, fs_fcs_dairy, fs_fcs_sugar, fs_fcs_fat",
                                "i.fcs_cat",   "Added",                                                                                                                   "Computed based on i.fcs (thresholds 21-35)",
                                   "i.rcsi",   "Added",                                                                                            "Computed with rCSIBorrow, rCSIMealSize, rCSIMealAdult, rCSIMealNb",
                               "i.rcsi_cat",   "Added",                                                                                                                   "Computed based on i.rcsi (thresholds 3-18)",
                                    "i.hhs",   "Added",                                                                         "Computed with fs_hhs_no_food_freq, fs_hhs_sleephungry_freq, fs_hhs_daynoteating_freq",
                                "i.hhs_cat",   "Added",                                                                                                                 "Computed based on i.hhs (thresholds 1, 3, 6)",
